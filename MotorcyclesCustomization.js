...
const MotorcyclesCustomization = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      <TabBar />
      <ImageBackground
        source={require('./girlbike.jpeg')} // First image
        style={styles.imageBackground}
      >
        <View style={styles.overlayContent}>
          <Text style={styles.customtext}>Customize your Bike</Text>
          <TouchableOpacity
            style={styles.blockOption}
            onPress={() => {/* navigation code */}}
          >
            <Text style={styles.blockOptionText}>Lets Do It </Text>
          </TouchableOpacity>
        </View>
      </ImageBackground>
      ...
      <View style={styles.textBlock}>
       <Text style={styles.bluetext}>CUSTOMIZE YOUR MOTORCYCLE AT AUDIOTECHNIKS</Text>
...
export default MotorcyclesCustomization;
